...
MODULE_DESCRIPTION("Sets LED using GPIO 4 and reads value from a button connected to GPIO 17");
...
/**
 * @Function is called to Read data out of the buffer
 */
...
/**
 * @Function to Write data into buffer
 */
